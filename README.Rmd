...
read_csv("predicciones.csv") %>%
  knitr::kable(., digits = 2, col.names = c("Fecha", "Casos Totales Observados", "Predicción", "Error"))
...
read_csv("predicciones_nuevos.csv") %>%
  knitr::kable(., digits = 2, col.names = c("Fecha", "Casos Nuevos Observados", "Predicción", "Error"))
