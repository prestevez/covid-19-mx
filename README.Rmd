...
Por tanto, considerando las limitaciones de los datos, **los resultados del modelo no deben de considerarse como predicciones robustas**. Son aproximaciones extremadamente ingenuas para dar una idea general de cómo podría evolucionar el fenómeno con base en los datos existentes.
...
Un ejercicio similar elaborado por expertos para el caso italiano puede encontrarse en Ramuzzi y Ramuzzi (2020).
